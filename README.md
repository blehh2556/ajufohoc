...
3. Type in your work experience using the necessary markdown formatting guides on this [Page](https://www.markdownguide.org/basic-syntax/) 

4. An important note is to be consistent with your heading sizes for each section. if you have an Education section with Heading Level 2 , Your work experience should also be level 2
...
5. `ctrl + Click` on the link generated in the output to view your repository. 

6. On the right hand side you should see **"github-pages** under deployment. Clicking on the first link on that page will take you to your Resume!
