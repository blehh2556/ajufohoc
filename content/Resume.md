...
Kode With Klossy Instructor Assistant \(Mar 2025 - Aug 2025\) 

- Completed camp training in HTML, CSS, and JavaScript to support instruction in web development.
- Worked as an Instructor Assistant for three consecutive summer camps, assisting with lesson delivery and live coding activities.
- Supported students by answering technical questions, debugging code, and providing one-on-one help.
...
**Safe space platform - gamified mental health**
...
**Programming**:  Java, C, Python, JavaScript, HTML/CSS, React.js, GDScript, Godot, Next.js, R 
